    ...
    <div className="w-full flex flex-col items-center justify-center">
      <div className="aboutBox w-full md:w-[80%] xl:w-[50%] mb-6">
        <p>
          ...
          At <span className="font-semibold text-amber-300">Recipe Adda</span>, we're more than an app—we're a community of food lovers. We’re here to help you discover new flavors, master classic techniques, and share your own creations with a supportive network. Welcome to the family!
        </p>
      </div>
      ...
      <div className="aboutBox w-full md:w-[80%] xl:w-[50%] mb-6">
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>🔍 Search by title, tags, or ingredients to find what you need fast.</li>
      ...
      <div className="aboutBox w-full md:w-[80%] xl:w-[50%] my-16 flex items-center justify-center">
        <p>Ready to get cooking? Download <span className="text-amber-300 hover:underline hover:cursor-pointer hover:text-amber-400">Recipe Adda</span> and start your culinary journey today!</p>
      </div>
